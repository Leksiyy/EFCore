...
public class DbInit
{
    public void Init(ApplicationContext context)
    {
        ...
        if (!context.Categories.Any())
        {
            ...
            (
                new Category { Name = "Artistic", Description = "The specificity of fiction is revealed by comparing it with art forms that use " +
                                                                "other material instead of verbal and linguistic material." },
                new Category { Name = "Adventure", Description = "The genre is close to action movies, but unlike the latter, in adventure films, " +
        ...
        if (!context.Books.Any())
        {
            Book theNightShip = new Book
            {
                ...
                Publisher = "Jess Kidd",
                Category = context.Categories.FirstOrDefault(c => c.Name == "Artistic"),
            ...
            Book theOnlySurvivors = new Book
            {
                ...
                Category = context.Categories.FirstOrDefault(c => c.Name == "Adventure"),
                Authors = new List<Author>()
                {
