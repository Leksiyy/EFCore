...
class Program
{
    static void Main()
    {
        ...
        using (ApplicationContext db = new ApplicationContext())
        {
            ...
            var comp = db.Users.FromSqlRaw("select * from Users").Include(c => c.Company).ToList();
        }
    }
}
...
public class ApplicationContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer(@"Server=localhost;Database=EfCore;User Id=SA;Password=MisterLeha197618;TrustServerCertificate=True;");
    }
